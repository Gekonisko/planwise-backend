...
{
    private static readonly string[] ProjectIdNameColumns = ["project_id", "name"];
    private static readonly string[] ProjectIdUserIdColumns = ["project_id", "user_id"];
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            ...
            columns: ProjectIdUserIdColumns,
            unique: true);

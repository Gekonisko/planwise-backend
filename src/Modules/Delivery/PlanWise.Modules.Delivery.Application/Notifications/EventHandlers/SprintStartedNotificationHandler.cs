...
public sealed class SprintStartedNotificationHandler(
    IProjectMembersService projectMembersService,
    INotificationPublisher notificationPublisher)
    : DomainEventHandler<SprintStartedDomainEvent>
{
    public override async Task Handle(SprintStartedDomainEvent domainEvent, CancellationToken cancellationToken = default)
    {
